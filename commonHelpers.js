import{i,S as u}from"./assets/vendor-8c59ed88.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function o(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(e){if(e.ep)return;e.ep=!0;const r=o(e);fetch(e.href,r)}})();function f(t){const s="https://pixabay.com",o="/api/",n=new URLSearchParams({key:"44024733-f77ed4f0ed7e81c67856c8782",q:t,image_type:"photo",orientation:"horizontal",safesearch:!0}),e=`${s}${o}?${n}`;return fetch(e).then(r=>r.json())}function m(t){return`
    ...
    `}function d(t){return t.map(m).join("")}const p=document.querySelector(".search-form"),l=document.querySelector(".gallery"),c=document.querySelector(".loader");function g(t){t.preventDefault();const s=t.target.elements.searchQuery.value.trim();if(!s){i.info({title:"No data",message:"Please enter a search query"});return}l.innerHTML="",f(s).then(o=>{h();const n=d(o.hits);if(!o.hits.length){i.error({title:"No result",message:"Sorry, there are no images matching your search query. Please try again!"});return}l.insertAdjacentHTML("beforeend",n),new u(".gallery a").refresh()}).catch(o=>{i.warning({title:"Error",message:`Something went wrong. ${o.message}`})}).finally(()=>{t.target.reset(),y()})}p.addEventListener("submit",g);function h(){c.style.display="block"}function y(){c.style.display="none"}
